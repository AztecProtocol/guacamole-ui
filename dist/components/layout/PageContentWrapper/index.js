...
var PageContentWrapper = function PageContentWrapper(_ref) {
  ...
  return _react.default.createElement(_Block.default, {
    ...
    styleName: (0, _classnames.default)('content', alignCenter && (0, _generateResponsiveStyleNames.default)('align-center', (0, _generateResponsiveStyleNames.responsiveStyleConfigAdaptor)(alignCenter)) || '', expand && (0, _generateResponsiveStyleNames.default)('expand', (0, _generateResponsiveStyleNames.responsiveStyleConfigAdaptor)(expand)) || '', {
      stretch: stretch
    })
  }, children));
};
