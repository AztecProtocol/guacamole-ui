...
var RealImage = /*#__PURE__*/function (_PureComponent) {
  _inherits(RealImage, _PureComponent);

  var _super = _createSuper(RealImage);
  ...
  _createClass(RealImage, [{
    ...
    value: function renderImage() {
      ...
      if (backgroundUrl) {
        ...
        return /*#__PURE__*/_react["default"].createElement("div", {
          className: styles.bg,
          style: imageStyle
        }, !showPlaceholder && !loaded && !error && /*#__PURE__*/_react["default"].createElement("img", {
          className: styles['preload-img'],
          ref: this.img,
          src: src || backgroundUrl,
          alt: "",
    ...
    value: function render() {
      ...
      }, this.renderImage(), hasPlaceholder && /*#__PURE__*/_react["default"].createElement(_ImagePlaceholder["default"], {
