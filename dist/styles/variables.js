...
var _default = {
  ...
  darkBackgroundColors: ['primary', 'primary-light', 'primary-lighter', 'secondary', 'secondary-light', 'black', 'grey-darker', 'grey-dark', 'grey', 'red', 'purple', 'blue', 'green', 'orange', 'brown', 'white-lightest'],
  ...
  buttonSizeKeys: ['xxs', 'xs', 's', 'm', 'l', 'xl', 'xxl'],
  colorNames: ['primary', 'primary-light', 'primary-lighter', 'primary-lightest', 'black', 'grey-darker', 'grey-dark', 'grey', 'grey-light', 'grey-lighter', 'grey-lightest', 'white', 'white-light', 'white-lighter', 'white-lightest', 'transparent', 'secondary', 'secondary-light', 'secondary-lighter', 'secondary-lightest', 'pink', 'red', 'purple', 'blue', 'green', 'yellow', 'orange', 'brown'],
  backgroundNames: ['primary', 'primary-light', 'primary-lighter', 'primary-lightest', 'black', 'grey-darker', 'grey-dark', 'grey', 'grey-light', 'grey-lighter', 'grey-lightest', 'white', 'white-light', 'white-lighter', 'white-lightest', 'transparent', 'secondary', 'secondary-light', 'secondary-lighter', 'secondary-lightest', 'pink', 'red', 'purple', 'blue', 'green', 'yellow', 'orange', 'brown'],
  textColorNames: ['primary', 'primary-light', 'primary-lighter', 'primary-lightest', 'black', 'grey-darker', 'grey-dark', 'grey', 'grey-light', 'grey-lighter', 'grey-lightest', 'white', 'white-light', 'white-lighter', 'white-lightest', 'transparent', 'secondary', 'secondary-light', 'secondary-lighter', 'secondary-lightest', 'pink', 'red', 'purple', 'blue', 'green', 'yellow', 'orange', 'brown', 'default', 'label'],
  overlayThemeNames: ['primary', 'secondary', 'white'],
  defaultInputSizeKey: 'm',
  inputSizeKeys: ['xs', 's', 'm', 'l'],
  inputThemeNames: ['default', 'inline', 'dark'],
  inputStatusNames: ['error', 'focus'],
  deviceBreakpointKeys: ['xxl', 'xl', 'l', 'm', 's', 'xs', 'xxs'],
  defaultDeviceBreakpointKey: 'xxs',
  sizeKeys: ['xxs', 'xs', 's', 'm', 'l', 'xl', 'xxl'],
  defaultSize: '8px',
  maxGridColumns: 12,
  roundedCornerKeys: ['none', 'xxs', 'xs', 's', 'm', 'l', 'circular'],
  defaultRoundedCornerKey: 'xs',
  shadowLayerKeys: [0, 1, 2, 3],
  imageRatioNames: ['square', 'classic', 'golden', 'landscape', 'ultra'],
  shapeSizeKeys: ['xxs', 'xs', 's', 'm', 'l', 'xl', 'xxl'],
  iconRotateDegrees: [0, 90, 180, 270],
  fontSizeKeys: ['xxs', 'xs', 's', 'm', 'l', 'xl', 'xxl'],
  defaultFontSizeKey: 'xs',
  fontWeightKeys: ['inherit', 'light', 'normal', 'medium', 'semibold', 'bold'],
  specialTextColorNames: ['default', 'label']
};
